...
<div class="div_titulo"> <h10>Atendimentos</h10> <i class="fas fa-tools"> </i> </div>

<div style="background:#F0E68C; padding-left: 10px; padding-right: 10px; margin-bottom: 10px; ">

Bem vindo a página de atendimentos !
</br></br>
<a href='img/emConstrucao.jpg'><img src='img/emConstrucao.jpg' width= 500px heigth= 400px/></a>
</br></br>
